...
class OperatorsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create operator" do
    assert_difference('Operator.count') do
      post operators_url, params: { operator: { email: @operator.email, image: @operator.image, name: @operator.name, password_digest: @operator.password_digest, surname: @operator.surname } }
    end
  ...
  test "should update operator" do
    patch operator_url(@operator), params: { operator: { email: @operator.email, image: @operator.image, name: @operator.name, password_digest: @operator.password_digest, surname: @operator.surname } }
